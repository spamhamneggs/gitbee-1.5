    ...
    >
      <div
        className={`w-full h-auto bg-white sticky z-10 px-5 transition-all ease-in-out duration-0 visible ${
          props.expand ? "top-56  sm:top-60 lg:top-[12.25rem]" : "top-28"
        }`}
      >
      ...
      <motion.div
        className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-5 h-fit gap-5 md:gap-7 lg:gap-5 xl:gap-10 justify-center items-start transition-all ease-in-out duration-500 pt-3 sm:pt-14 lg:pt-3`}
        initial="hidden"
        whileInView="reveal"
